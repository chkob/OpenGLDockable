...
IMPLEMENT_DYNCREATE(CMainFrame, CFrameWnd)
      ...
      CCreateContext* pContext)
   {
      ...
      if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(100, 100), pContext) ||
         !m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(COpenGLDockableOrdinaryBrowseView), CSize(100, 100), pContext))
      {
   ...
   COpenGLDockableOrdinaryBrowseView* CMainFrame::GetRightPane()
   {
      CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
      COpenGLDockableOrdinaryBrowseView* pView = DYNAMIC_DOWNCAST(COpenGLDockableOrdinaryBrowseView, pWnd);
      return pView;
   }
   ...
   void CMainFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
   {
      ...
      COpenGLDockableOrdinaryBrowseView* pView = GetRightPane();
   ...
   void CMainFrame::OnViewStyle(UINT nCommandID)
   {
      ...
      // if the right-hand pane has been created and is a COpenGLDockableOrdinaryBrowseView,
